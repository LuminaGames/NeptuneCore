...
public enum Message {
    ...
    FALLBACK_CONNECTION("GENERAL.FALLBACK_CONNECTION"),
    PLAYER_NOT_FOUND("GENERAL.PLAYER_NOT_FOUND"),
    FIND_MESSAGE("GENERAL.FIND_MESSAGE"),
    ...
    SOCIAL_SPY_ON("SOCIAL_SPY.ENABLE"),
    SOCIAL_SPY_OFF("SOCIAL_SPY.DISABLE"),
    COMMAND_SPY_ON("COMMAND_SPY.ENABLE"),
    COMMAND_SPY_OFF("COMMAND_SPY.DISABLE"),
